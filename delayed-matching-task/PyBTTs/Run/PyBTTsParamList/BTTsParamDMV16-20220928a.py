...
def main01(args):
    ...
    #
    curParam.modeDelayedMatch.setValue(1); # 0:ポジション  1:形/色 
    curParam.modeOption.setValue(0);
    curParam.stim_list.setValue([[0,1],[3,4],[6,7]]); # listColor
    #curParam.stim_list.setValue([[0,3],[1,4],[2,5]]); # listShape
    #curParam.stim_list.setValue([[0,1,2],[3,4,5],[6,7,8]]); # listColor
    #curParam.stim_list.setValue([[0,3,6],[1,4,7],[2,5,8]]); # listShape
    #curParam.stim_list.setValue([[0,1,2,3,4,5,6,7,8]]); # listPosition
    #curParam.stim_list.setValue([[0,1,2]]); # listPosition
    #curParam.stim_list.setValue([[0,1,2],[4,5,6]]);  # 形の一致
    #curParam.stim_list.setValue([[0,3],[1,4],[2,5]]);  # 形の一致
